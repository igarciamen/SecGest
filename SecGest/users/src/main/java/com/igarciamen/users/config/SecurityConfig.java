...
import com.igarciamen.users.security.LoginRateLimitFilter;
...
public class SecurityConfig {
    ...
    @Bean
    @Order(1)
    SecurityFilterChain publicFilterChain(HttpSecurity http, LoginRateLimitFilter loginRateLimitFilter) throws Exception {
        http
